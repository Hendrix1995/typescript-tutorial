      ...
      {isLoading ? (
        ...
        <CardBody>
          <MainBody>
            ...
            <DateFilter startDate={startDate} endDate={endDate} getDateStr={getDateStr} today={today} lastMonth={lastMonth} startDateHandler={startDateHandler} endDateHandler={endDateHandler} />
